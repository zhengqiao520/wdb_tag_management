...
namespace DevLib.Data
{
    ...
    public class DbHelper
    {
            ...
            while (dbDataReader.Read())
            {
                ...
                for (int i = 0; i < dbDataReader.FieldCount; i++)
                {
                    ...
                    foreach (PropertyInfo propertyInfo in properties)
                    {
                        ...
                        {
                            propertyInfo.SetValue(item, ChangeType(dbDataReader[propertyInfo.Name], propertyInfo.PropertyType), null);
                            break;
                        }
                    }
                }
        ...
        public static object ChangeType(object value, Type conversionType)
        {
            ...
            if (conversionType.Equals(typeof(DateTime)) && value.Equals(""))
            {
                return null;
            }
            if (conversionType.Equals(typeof(bool)) && value.Equals(""))
            {
                return false;
            }
            ...
            if (conversionType.Equals(typeof(decimal)) && value.Equals(""))
            {
                return null;
            }
            if (conversionType.Equals(typeof(int)) && value.Equals(""))
            {
                return null;
            }
            if (conversionType.Equals(typeof(float)) && value.Equals(""))
            {
                return null;
            }
